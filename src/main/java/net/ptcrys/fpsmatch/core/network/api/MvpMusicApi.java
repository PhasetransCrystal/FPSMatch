package net.ptcrys.fpsmatch.core.network.api;

import net.ptcrys.fpsmatch.core.data.music.OnlineMusic;
import net.ptcrys.fpsmatch.core.network.ApiResponse;
import net.ptcrys.fpsmatch.core.network.NetworkModule;
import net.ptcrys.fpsmatch.core.network.RequestBuilder;
import net.ptcrys.fpsmatch.core.network.RequestMethod;
