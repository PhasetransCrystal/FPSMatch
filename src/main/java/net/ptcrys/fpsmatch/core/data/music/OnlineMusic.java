package net.ptcrys.fpsmatch.core.data.music;

import net.ptcrys.fpsmatch.core.data.HashData;
import net.ptcrys.fpsmatch.core.network.download.DownloadHolder;
import net.ptcrys.fpsmatch.core.network.download.Downloader;
import net.ptcrys.fpsmatch.core.network.download.HashDownloadHolder;
import net.ptcrys.fpsmatch.core.persistence.PersistenceUtils;
import net.ptcrys.fpsmatch.util.hash.FileHashUtil;
...
public record OnlineMusic(String uuid, String musicUrl, String musicName, String coverUrl, String customMemo, HashData hashData) {
    ...
    public static final Codec<OnlineMusic> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            HashData.CODEC.fieldOf("hashData").forGetter(OnlineMusic::hashData)).apply(instance, OnlineMusic::new));
