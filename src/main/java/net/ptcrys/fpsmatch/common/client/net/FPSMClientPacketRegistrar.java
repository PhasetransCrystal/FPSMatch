...
public final class FPSMClientPacketRegistrar {
    ...
    public static synchronized void registerAll() {
        ...
        ClientPacketRegistry.register(SpectateModeS2CPacket.class, packet -> {
            net.ptcrys.fpsmatch.common.client.spec.SpectateState.set(packet.mode());
            if (packet.mode() == net.ptcrys.fpsmatch.common.client.spec.SpectateMode.FREE) {
                net.ptcrys.fpsmatch.common.client.spec.SpectatorCameraController.reset();
