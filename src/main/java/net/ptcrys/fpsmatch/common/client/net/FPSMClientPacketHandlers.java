...
import net.ptcrys.fpsmatch.common.client.screen.MapCreatorToolScreen;
import net.ptcrys.fpsmatch.common.client.screen.MatchConfigToolScreen;
...
import net.ptcrys.fpsmatch.common.packet.FPSMInventorySelectedS2CPacket;
...
import net.ptcrys.fpsmatch.common.packet.FPSMatchRespawnS2CPacket;
...
import net.ptcrys.fpsmatch.common.packet.OpenSpawnPointToolScreenS2CPacket;
import net.ptcrys.fpsmatch.common.packet.RemoveDebugDataByPrefixS2CPacket;
import net.ptcrys.fpsmatch.common.packet.mapselect.MapImportSourcesS2CPacket;
import net.ptcrys.fpsmatch.common.packet.mapselect.MapRoomDetailS2CPacket;
import net.ptcrys.fpsmatch.common.packet.mapselect.MapRoomInvitationS2CPacket;
import net.ptcrys.fpsmatch.common.packet.mapselect.MapRoomReadyStateS2CPacket;
...
import net.ptcrys.fpsmatch.common.packet.shop.OpenShopConfigToolScreenS2CPacket;
...
import net.ptcrys.fpsmatch.common.packet.team.TeamManageResultS2CPacket;
import net.ptcrys.fpsmatch.common.packet.team.TeamPlayerLeaveS2CPacket;
...
public final class FPSMClientPacketHandlers {
    ...
    public static void handleRespawn(FPSMatchRespawnS2CPacket packet) {
        ...
        if (mc.player != null) {
            net.ptcrys.fpsmatch.common.client.camera.CameraDirector.playerRespawn();
            mc.setScreen(null);
            mc.player.respawn();
        }
    }
    ...
    private static void resetCameraToPlayer(Minecraft mc) {
        net.ptcrys.fpsmatch.common.client.camera.CameraDirector.reset(
                net.ptcrys.fpsmatch.common.camera.CameraEndReason.MATCH_RESET);
    }
